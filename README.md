...
- 预配置了部分插件（包括但不限于 DNS 套娃，<b>(注意，使用dnsfilter作为广告过滤手段，使用dnsproxy作为dns分流措施，海外端口6051，国内端口6050，chinadns-ng监听端口5335。)</b>
- 可无脑 opkg kmod
...
|              [ElonH](https://github.com/ElonH)               |              [NateLol](https://github.com/NateLol)               |              [kiddin9](https://github.com/garypang13)               |
