...
pushd package/lean
wget -qO - https://github.com/QiuSimons/helloworld-fw876/commit/b1130e9.patch | patch -p1
wget -qO - https://github.com/QiuSimons/helloworld-fw876/commit/cc37231.patch | patch -p1
popd
