...
pushd package/lean
wget -qO - https://github.com/QiuSimons/helloworld-fw876/commit/72bee5e.patch | patch -p1
wget -qO - https://github.com/QiuSimons/helloworld-fw876/commit/deacdd3.patch | patch -p1
popd
