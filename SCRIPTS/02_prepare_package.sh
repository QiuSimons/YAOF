...
svn co https://github.com/coolsnowwolf/packages/trunk/net/adbyby package/lean/adbyby
# 广告过滤 AdGuard
...
# 这个在目录里面没有找到但需要这个依赖 svn co https://github.com/coolsnowwolf/packages/trunk/net/rblibtorrent package/lean/rblibtorrent
