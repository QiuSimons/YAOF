...
# BBR_Patch（2.0
wget -P target/linux/generic/pending-4.14/ https://github.com/immortalwrt/openwrt/raw/openwrt-18.06/target/linux/generic/pending-4.14/607-tcp_bbr-adapt-cwnd-based-on-ack-aggregation-estimation.patch
