...
#3328 add idle
wget -P target/linux/rockchip/patches-5.4 https://github.com/immortalwrt/openwrt/raw/master/target/linux/rockchip/patches-5.4/007-arm64-dts-rockchip-Add-RK3328-idle-state.patch
#IRQ
...
#r8152新驱动（可选
#wget -O- https://github.com/immortalwrt/openwrt/commit/d8df86130d172b3ce262d2744e2ddd2a6eed5f50.patch | patch -p1
#svn co https://github.com/immortalwrt/openwrt/branches/master/package/ctcgfw/r8152 package/new/r8152
